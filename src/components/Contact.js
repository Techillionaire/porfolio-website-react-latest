    ...
    <section>
      <div className='container flex flex-col px-4 py-14 space-y-6 justify-center md:space-y-0 md:flex-row'>
        ...
        <div className='md:w-1/2 flex flex-col px-6'>
          <h2 className="max-w-md text-3xl font-bold text-center md:text-start -mt-14 md:mt-0  py-4 md:justify-center">Contact</h2>

          <form className='flex flex-col space-y-6 md:space-y-10 md:mt-8'>
